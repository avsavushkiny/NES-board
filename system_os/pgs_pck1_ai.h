...
void drawAliens()
{
  for (int i = 0; i < 3; i++)   //y
  {
    for (int j = 0; j < 9; j++) //x
    {
      if (boxAliens[i][j] == 0) u8g2.drawXBMP(j * 10, i * 8, al1_w, al1_h, al1_bits);
      if (boxAliens[i][j] == 1) u8g2.drawXBMP(j * 10, i * 8, al1_w, al1_h, al2_bits);
      if (boxAliens[i][j] == 2) u8g2.drawXBMP(j * 10, i * 8, al1_w, al1_h, al3_bits);
      if (boxAliens[i][j] == 3) u8g2.drawXBMP(j * 10, i * 8, al1_w, al1_h, al4_bits);
    }
  }
}
